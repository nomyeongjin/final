document.addEventListener('DOMContentLoaded', function () {
    ...
    async function generateSchedule() {
        ...
        let offWeekArr = map.offWeek.slice(0, -1).split('/');
        ...
        if(map.openBreak.breaktimeStart == null || map.openBreak.breaktimeStart == '00:00') breaktime = "없음";
        ...
        for (let i = 0; i < 7; i++) { // 요일별행에 날짜-요일-영업시간-브레이크타임 추가하는 반복문 (0은 오늘 기준)
            ...
            // span에 영업 상태 표시
            if(offWeekArr.includes(String(currentDay))) storeStatusText.innerText = "휴무일";
