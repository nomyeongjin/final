...
CONSTRAINT "READ_FL_CHECK"
CHECK("READ_FL" IN('Y','N'));
...
SELECT ROUND(AVG(REVIEW_RATING),1)  FROM "REVIEW"
WHERE STORE_NO=1 ;
...
UPDATE "STORE" SET STORE_LOCATION ='04629^^^서울 중구 퇴계로 124^^^충무로2가 109-2'
